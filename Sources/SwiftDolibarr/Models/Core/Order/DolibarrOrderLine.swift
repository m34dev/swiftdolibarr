...
@Observable
#endif
public final class DolibarrOrderLine: CommonCommercialTransactionObjectLine {
    ...
    public init(copying source: DolibarrOrderLine) {
    ...
    public func copy(_ source: DolibarrOrderLine) {
        self.orderId = source.orderId
        super.copy(source)
    }
