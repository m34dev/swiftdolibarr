...
//
//  DolibarrUserPermissionsLaReponseTag.swift
//  SwiftDolibarr
//
...
/// La Réponse tag permissions for a Dolibarr user.
///
/// - SeeAlso: ``DolibarrUserPermissionsLaReponse``
public struct DolibarrUserPermissionsLaReponseTag: Codable, Hashable {
    ...
    public init(write: Int? = nil, delete: Int? = nil) {
        self.write = write
        self.delete = delete
    }
